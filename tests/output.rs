    ...
    assert_failure_output(
        ...
        r#"
            ...
            error: invalid value 'rustz' for '--language <LANGUAGE>'
              [possible values: c, cpp, c-sharp, css, dockerfile, elisp, elm, go, html, java, javascript, json, kotlin, lua, objective-c, python, ruby, rust, swift, toml, tree-sitter-query, typescript]
